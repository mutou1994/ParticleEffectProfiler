...
public class EffectEvla
{
    ...
    public EffectEvla(Camera camera, bool bPreview)
    {
        SetCamera(camera, bPreview);
    ...
    public void SetCamera(Camera camera, bool bPreview)
    {
        _camera = camera;
        if(bPreview)
        {
    ...
    {
        time = 0;
        singleEffectEvla.Clear();
    }

    public void SetEffectPath(string path)
    {
        var effectEvlaData = singleEffectEvla.GetEffectEvlaData();
        effectEvlaData.effectPath = path;
    }

    public void SetQuality(TestEffectQuality quality)
    {
        var effectEvlaData = singleEffectEvla.GetEffectEvlaData();
        effectEvlaData.quality = quality;
    }
    ...
    {
        return singleEffectEvla.GetEffectEvlaData();
    }
